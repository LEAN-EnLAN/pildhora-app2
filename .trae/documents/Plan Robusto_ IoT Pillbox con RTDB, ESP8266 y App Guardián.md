...
2) Pre‑cálculo de Configuración
...
3) Provisioning por Captive Portal
...
2) Firmware: auth, AP/captive portal, NTP/time_synced, cola transaccional, motor/acks, LittleFS.
